...
\boldtheme{Saturation} controls the levelat which the hysteresis
function saturates. Higher values correspond to a lower Saturation
point, resulting in a more distorted sound.

\begin{figure}[ht]
    \center
    \includegraphics[width=0.9\columnwidth]{../Simulations/Hysteresis/sat.png}
...
\begin{figure}[ht]
    \center
    \includegraphics[width=0.9\columnwidth]{../Simulations/Hysteresis/bias.png}
...
\begin{figure}[ht]
    \center
    \includegraphics[width=0.9\columnwidth]{../Simulations/LossEffects/space_loss.png}
...
\begin{figure}[ht]
    \center
    \includegraphics[width=0.9\columnwidth]{../Simulations/LossEffects/speed_thickness.png}
...
To save the currenet plugin state as a user preset, open
