...
\end{equation}
%
where $g$ is the head gap, and $H_0$ isthe deep gap field, given by:
...
\end{equation}
%
for sinusoidal input, where $k$ is the wave number, $d$ is the distance between the tape and the playhead,
...
as well are dependent on the tape speed.
\newline\newline
...
\begin{figure}[ht]
    \center
    \includegraphics[width=3in]{../Simulations/BiasEx.png}
...
\section{Results of Real-Time System}
@TODO
